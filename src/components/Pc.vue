            ...
            <footer class="footer">
                <div class="footer-body">
                    ...
                    <div class="compony-info">
                        <img class="ci-logo" src="@/assets/images/basic/erniu_logo.png" alt="">
                        <div class="ci-sub">
                            <img src="@/assets/images/basic/label.jpg" alt="">
                            <div class="ci-text">
...
export default defineComponent({
    ...
    setup() {
        ...
        const roleImgList = ref([
            {
                manImageUrl: require('@/assets/images/role/jlm_info.png'),
                womanImageUrl: require('@/assets/images/role/jlw_info.png'),
                manIconImageUrl: require('@/assets/images/role/jlm_active.png'),
                wumanIconImageUrl: require('@/assets/images/role/jlw_active.png'),
                active: true,
            },
            {
                manImageUrl: require('@/assets/images/role/lmm_info.png'),
                womanImageUrl: require('@/assets/images/role/lmw_info.png'),
                manIconImageUrl: require('@/assets/images/role/lmm_active.png'),
                wumanIconImageUrl: require('@/assets/images/role/lmw_active.png'),
                active: false,
            },
            {
                manImageUrl: require('@/assets/images/role/mdn_info.png'),
                womanImageUrl: require('@/assets/images/role/mdw_info.png'),
                manIconImageUrl: require('@/assets/images/role/mdm_active.png'),
                wumanIconImageUrl: require('@/assets/images/role/mdw_active.png'),
                active: false,
            },
            {
                manImageUrl: require('@/assets/images/role/sjm_info.png'),
                womanImageUrl: require('@/assets/images/role/sjw_info.png'),
                manIconImageUrl: require('@/assets/images/role/jsm_actvie.png'),
                wumanIconImageUrl: require('@/assets/images/role/jsw_active.png'),
                active: false,
            },
            {
                manImageUrl: require('@/assets/images/role/sqm_info.png'),
                womanImageUrl: require('@/assets/images/role/sqw_info.png'),
                manIconImageUrl: require('@/assets/images/role/sqm_active.png'),
                wumanIconImageUrl: require('@/assets/images/role/sqw_active.png'),
                active: false,
            },
            {
                manImageUrl: require('@/assets/images/role/stm_info.png'),
                womanImageUrl: require('@/assets/images/role/stw_info.png'),
...
@import "src/assets/style/pc/pc.scss";
</style>
